...
Webflow.require('ix').init([
  {"slug":"goal-section-on-load","name":"Goal Section On Load","value":{"style":{"display":"none"},"triggers":[]}},
  {"slug":"goal-button","name":"Goal Button","value":{"style":{},"triggers":[{"type":"click","selector":".goal_container","stepsA":[{"display":"block","height":"0px"},{"height":"auto"}],"stepsB":[{"height":"0px"},{"display":"none"}]}]}}
]);
